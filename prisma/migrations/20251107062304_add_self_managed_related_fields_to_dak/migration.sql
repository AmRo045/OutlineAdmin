...
INSERT INTO "new_DynamicAccessKey" ("createdAt", "expiresAt", "id", "loadBalancerAlgorithm", "name", "path", "prefix", "updatedAt") SELECT "createdAt", "expiresAt", "id", "loadBalancerAlgorithm", "name", "path", "prefix", "updatedAt" FROM "DynamicAccessKey";
